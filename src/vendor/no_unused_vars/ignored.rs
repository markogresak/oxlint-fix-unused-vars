// Synced from oxc @ 14533a3dc118bea73e755426aaf35f71dbe81eb8: crates/oxc_linter/src/rules/eslint/no_unused_vars/ignored.rs
...
impl NoUnusedVars {
    ...
    fn search_assignment_maybe_default<'a>(
        ...
        assignment
            ...
            .map_or(FoundStatus::NotFound, |assignment| {
